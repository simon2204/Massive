...
/// Query parameters for the Cash Flow Statements endpoint.
///
/// Get cash flow statement data from SEC filings.
///
/// Use Cases: Cash flow analysis, liquidity assessment, investment decisions.
///
/// ## Example
/// ```swift
/// // Latest cash flow statements for AAPL
/// let query = CashFlowStatementsQuery(tickers: "AAPL")
///
/// // Annual reports for 2023
/// let query = CashFlowStatementsQuery(tickers: "AAPL", fiscalYear: 2023, timeframe: .annual)
/// ```
public struct CashFlowStatementsQuery: APIQuery {
